    ...
    <div className='flex h-full justify-center'>
      <div className='flex w-6/12 flex-col gap-4'>
        <h1 className='pt-20 text-4xl font-bold'>
          Privacy Policy for Better Playlist
        </h1>

        <p>
          At Better Playlist, accessible from
          https://spotify-better-playlist.vercel.app, one of our main priorities
          is the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by Better Playlist
          and how we use it.
        </p>
        ...
        <p>
          ...
          advertising partners of Better Playlist.
        </p>
        ...
        <p>
          Note that Better Playlist has no access to or control over these
        ...
        <p>
          Better Playlist does not knowingly collect any Personal Identifiable
        ...
        <p>
          ...
          shared and/or collect in Better Playlist. This policy is not
